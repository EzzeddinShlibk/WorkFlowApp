    ...
    public partial class m1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "03c1d7de-d768-45e0-a6fc-e55ec1d261fd", null, "Admin", "ADMIN" },
                    { "954cb25f-af3d-42a6-bd92-322c73c61b48", null, "User", "USER" },
                    { "a85d063d-8d30-4c4a-826b-f126390c6819", null, "Prog", "PROG" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "8ccb9e2e-8643-43b6-a687-153cdf3a4461", 0, "98857a4a-900a-4e86-b5a8-15017c4d932f", new DateTime(2024, 3, 25, 9, 36, 24, 661, DateTimeKind.Local).AddTicks(9096), "Manager@Gmail.com", true, false, null, null, "MANAGER@GMAIL.COM", "MANAGER@GMAIL.COM", "AQAAAAIAAYagAAAAEENBn25nctvh+Y30rSkYQZCQlRWmJL8rGI5sAyoDRcRRAfSAhOmC/BQF7FesliUfTQ==", null, true, "00000000-0000-0000-0000-000000000000", false, "Manager@Gmail.com" },
                    { "dbf36bcf-1d00-44b2-b74e-1cff8d81dc1a", 0, "f2c50d02-f33b-4a3e-86fd-52aacef0a869", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(599), "Programmer@Gmail.com", true, true, null, null, "PROGRAMMER@GMAIL.COM", "PROGRAMMER@GMAIL.COM", "AQAAAAIAAYagAAAAEDDCWQttOoVmUI/BWuZuAp7111b03srM1sWG9/9JSC+eCIDj0DDSKxQTBbFnoYG0Nw==", null, true, "00000000-0000-0000-0000-000000000000", false, "Programmer@Gmail.com" }
                });

            migrationBuilder.InsertData(
                table: "Contacts",
                columns: new[] { "Id", "Address", "CreatedDate", "Email1", "Email2", "Facebook", "ModifiedDate", "Phone1", "Phone2" },
                values: new object[] { new Guid("69a7866b-bf4b-42f8-b392-ae9b6766edbd"), "طرابلس ليبيا", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(396), "flowmaster@gmail.com", "flowmaster.co@gmail.com", "flowmaster home", null, "0923333333", "0912223344" });

            migrationBuilder.InsertData(
                table: "Features",
                columns: new[] { "Id", "Content1", "Content2", "Content3", "Pic1", "Pic2", "Pic3", "Title1", "Title2", "Title3" },
                values: new object[] { new Guid("c6cce927-cace-4136-bbb9-e90d5a8af6c7"), "يمكنك إنشاء المهام وتتبعها وأتمتتها وإكمالها لتبسيط العمليات وتحسين الكفاءة.", "يمكنك إنشاء المهام وتتبعها وأتمتتها وإكمالها لتبسيط العمليات وتحسين الكفاءة.", "يمكنك إنشاء المهام وتتبعها وأتمتتها وإكمالها لتبسيط العمليات وتحسين الكفاءة.", "1.webp", "2.png", "3.png", "سير العمل", "وحدة المراقبة المركزية", "المهام والتعاون الفعال" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("50cf8fc7-8e16-4e93-a1dc-09a6d254cf65"), "pink", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(485), null, "اولوية مبدئية", 2 },
                    { new Guid("718f9ff2-62d8-49d5-a208-260c3467df6c"), "danger", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(491), null, "اولوية قصوى", 4 },
                    { new Guid("79c02f49-3a62-4f38-9ea1-c1a277793fac"), "secondary", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(483), null, "بدون اولوية", 1 },
                    { new Guid("a9c65de9-ff54-4e9f-86c5-1d1eecdd9e87"), "warning", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(487), null, "اولوية متوسطة", 3 }
                });

            migrationBuilder.InsertData(
                table: "SiteStates",
                columns: new[] { "Id", "ClosingMessage", "CreatedDate", "ModifiedDate", "State" },
                values: new object[] { new Guid("4c914cfd-695f-4168-9968-08a3d370f331"), "الموقع مغلق مؤقتا للتطوير", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(231), null, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("7f2184d9-7225-46bb-8174-91445ab77970"), "success", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(460), "fas fa-check-circle", null, "مكتملة", 5 },
                    { new Guid("a9c78079-1c37-4ae4-8642-8327059df211"), "blue", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(459), "fas fa-tasks", null, "قيد التنفيد", 4 },
                    { new Guid("abd05e0a-425f-45b5-8fbe-55bb664e1379"), "warning", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(457), "fas fa-clipboard-check", null, "بانتظار المراجعة", 3 },
                    { new Guid("b3b52301-4c57-498f-9d12-d1c55e1ef76e"), "danger", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(455), "fas fa-stop-circle", null, "توقف حرج", 2 },
                    { new Guid("d8786ab4-ef66-4299-bcbe-7ee19b2ed1e1"), "purple", new DateTime(2024, 3, 25, 9, 36, 24, 603, DateTimeKind.Local).AddTicks(452), "fas fa-clock", null, "بانتظار البدء", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a85d063d-8d30-4c4a-826b-f126390c6819", "8ccb9e2e-8643-43b6-a687-153cdf3a4461" },
                    { "a85d063d-8d30-4c4a-826b-f126390c6819", "dbf36bcf-1d00-44b2-b74e-1cff8d81dc1a" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("8b381d23-0beb-4250-b2d1-fd5e21d83ca2"), new DateTime(2024, 3, 25, 9, 36, 24, 722, DateTimeKind.Local).AddTicks(2558), "Manager", false, null, "093435345", "1", "8ccb9e2e-8643-43b6-a687-153cdf3a4461", "" },
                    { new Guid("cea1977e-be98-4fc0-831e-d4f8f52e218f"), new DateTime(2024, 3, 25, 9, 36, 24, 661, DateTimeKind.Local).AddTicks(9024), "Programmer", false, null, "09233333333", "1", "dbf36bcf-1d00-44b2-b74e-1cff8d81dc1a", "" }
                });
